    ...
    <div className="flex flex-col">
      ...
      <section className="bg-gradient-to-b from-brand-50 to-white py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-100 text-brand-700 text-xs font-medium rounded-full mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {facets.categories.map(cat => (
              ...
              >
                ...
                <div className="font-medium text-gray-900 group-hover:text-brand-600 text-sm">{cat.value}</div>
                <div className="text-xs text-gray-400 mt-0.5">{formatNumber(cat.count)} products</div>
              </Link>
            ))}
          </div>
        </section>
